...
let Iconyemian: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Iconyemian.defaultProps = {
  size: 18,
};

Iconyemian = React.memo ? React.memo(Iconyemian) : Iconyemian;

export default Iconyemian;
