...
let Iconyemian1: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
Iconyemian1.defaultProps = {
  size: 18,
};

Iconyemian1 = React.memo ? React.memo(Iconyemian1) : Iconyemian1;

export default Iconyemian1;
