...
let Iconhuiyuan4: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
    <Svg viewBox="0 0 1024 1024" width={size} height={size} {...rest}>
      ...
      <Path
        ...
        fill={getIconColor(color, 9, '#3E3A39')}
      />
      <Path
        ...
        fill={getIconColor(color, 10, '#FCEE21')}
      />
      <Path
        ...
        fill={getIconColor(color, 11, '#F8B62D')}
      />
      <Path
        ...
        fill={getIconColor(color, 12, '#3E3A39')}
      />
      <Path
      ...
      />
      <Path
        d="M502.5 886.9L630.4 512"
        fill={getIconColor(color, 14, '#FCEE21')}
      />
      <Path
        ...
        fill={getIconColor(color, 15, '#3E3A39')}
      />
      <Path
        d="M501.1 886.9L363.7 502.4"
        fill={getIconColor(color, 16, '#FCEE21')}
      />
      <Path
      ...
      <Path
        ...
        fill={getIconColor(color, 18, '#3E3A39')}
      />
      <Path
      ...
      <Path
        ...
        fill={getIconColor(color, 20, '#3E3A39')}
      />
      <Path
...
Iconhuiyuan4.defaultProps = {
  size: 18,
};

Iconhuiyuan4 = React.memo ? React.memo(Iconhuiyuan4) : Iconhuiyuan4;

export default Iconhuiyuan4;
